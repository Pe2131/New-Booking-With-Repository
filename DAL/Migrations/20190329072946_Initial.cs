        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForAdultUro = table.Column<decimal>(nullable: false),
                    PriceForAdultDollar = table.Column<decimal>(nullable: false),
                    PriceForBabyUro = table.Column<decimal>(nullable: false),
                    PriceForBabyDollar = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_PathWay", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UserId_FG = table.Column<string>(nullable: true),
                    PathwayId_FG = table.Column<int>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    Time = table.Column<string>(nullable: true),
                    AdultCount = table.Column<int>(nullable: false),
                    BabyCount = table.Column<int>(nullable: false),
                    SumPrice = table.Column<decimal>(nullable: false),
                    isPayed = table.Column<bool>(nullable: false),
                    UseDisCount = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_Factore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tbl_Factore_Tbl_PathWay_PathwayId_FG",
                        column: x => x.PathwayId_FG,
                        principalTable: "Tbl_PathWay",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tbl_Factore_AspNetUsers_UserId_FG",
                        column: x => x.UserId_FG,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
